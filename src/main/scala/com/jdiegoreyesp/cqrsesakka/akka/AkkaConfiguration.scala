package com.jdiegoreyesp.cqrsesakka.akka
...
/**
  ...
  * }}}
  */
class ImplicitAkkaConfiguration(implicit override val actorRefFactory: ActorRefFactory,
                                implicit override val materializer: Materializer,
                                implicit override val askTimeout: Timeout
